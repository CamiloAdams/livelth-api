...
var _Guide = _interopRequireDefault(require("../models/Guide"));
...
var getUserStats = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var token, decoded, user, usersAvg, usersHighScoreAvg, userAvg, scoresHistory;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            usersAvg = _context.sent;
            _context.next = 17;
            return usersAverageHighScore();
          case 17:
            usersHighScoreAvg = _context.sent;
            _context.next = 20;
            return userAverageScore(user.id);
          case 20:
            userAvg = _context.sent;
            _context.next = 23;
            return userScoreHistory(user.id);
          case 23:
            scoresHistory = _context.sent;
            res.status(201).json({
...
var getAdminStats = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var token, decoded, user, usersAvg, usersHighScoreAvg;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 12:
            ...
            return usersAverageScore();
          case 14:
            usersAvg = _context2.sent;
            _context2.next = 17;
            return usersAverageHighScore();
          case 17:
            usersHighScoreAvg = _context2.sent;
            _context2.t0 = res.status(201);
            _context2.t1 = usersHighScoreAvg;
            _context2.t2 = usersAvg;
            _context2.next = 23;
            return getGuidesXHighScore();
          case 23:
            _context2.t3 = _context2.sent;
            _context2.next = 26;
            return getAgeXHighScore();
          case 26:
            _context2.t4 = _context2.sent;
            _context2.t5 = {
              high_scores_avg: _context2.t1,
              avg_scores: _context2.t2,
              guides_vs_avg_high_score: _context2.t3,
              ages_vs_high_score: _context2.t4
            };
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            return _context3.abrupt("return", averageScore /= scores.length);
          case 6:
          case "end":
...
function usersAverageHighScore() {
  return _usersAverageHighScore.apply(this, arguments);
}
function _usersAverageHighScore() {
  _usersAverageHighScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var usersHighScores, averageScore, index, element;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            usersHighScores = _context4.sent;
            averageScore = 0;
            for (index = 0; index < usersHighScores.length; index++) {
              element = usersHighScores[index];
              averageScore += element.high_score;
            }
            return _context4.abrupt("return", averageScore /= usersHighScores.length);
          case 6:
          case "end":
...
function _getUsersScoresAndAge() {
  _getUsersScoresAndAge = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
    var users, ageMin, ageMax, index, element, m, r, c, statsObjectj, _index, _element, key, value, _element2;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 14:
            ...
            if (!(_element.age == ageMin)) {
              _context9.next = 22;
              break;
            }
            statsObjectj[key].num_usuarios += 1;
            statsObjectj[key].high_score_avg += _element.high_score;
            statsObjectj[key].usuarios.push(_element);
            return _context9.abrupt("break", 29);
          case 22:
            if (!(_element.age > value.edad_min && _element.age <= value.edad_max)) {
              _context9.next = 27;
              break;
            }
            statsObjectj[key].num_usuarios += 1;
