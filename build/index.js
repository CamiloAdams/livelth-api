...
var certificate = _fs["default"].readFileSync("./livelth.online/certificate.crt", "utf8", function (err) {
  if (err) console.log(err);
});
var privateKey = _fs["default"].readFileSync("./livelth.online/private.key", "utf8", function (err) {
  if (err) console.log(err);
});
var credentials = {
  key: privateKey,
